...
var resizePizzas = function(size) {
  ...
  // define new function to assign new width
  function assignWidth (size) {
    var newWidth;
    switch(size) {
      case "1":
        newWidth = 25;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // do not call this function when load the page
  //updatePositions();
});
